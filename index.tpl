  ...
  <body>
    <form action="send.py" method="post">
      ...
      <select name="centre_resource" id="id_centre_resource">
        ...
        <option value="r75">— Alvis</option>
        <option value="r68">— Cephyr NOBACKUP</option>
        <option value="r82">— Mimer</option>
        <option value="r63">— Vera</option>
        <option value="r43">— Cstor no-backup</option>
        <option value="r35">— Hebbe</option>
        <option value="c1">HPC2N</option>
        <option value="r49">— Kebnekaise</option>
        <option value="c11">LUMI Sweden</option>
        <option value="c5">LUNARC</option>
        <option value="r44">— Aurora</option>
        <option value="r70">— Centrestorage nobackup</option>
        <option value="r24">— Erik</option>
        <option value="c3">NSC</option>
        <option value="r79">— Berzelius Compute</option>
        <option value="r80">— Berzelius Storage</option>
        <option value="r45">— Centre Storage</option>
        <option value="r62">— Sigma</option>
        <option value="r61">— Tetralith</option>
        <option value="c7">PDC</option>
        <option value="r30">— Beskow</option>
        <option value="r71">— Klemming</option>
        <option value="r37">— Tegner</option>
        <option value="c10">SSC</option>
        <option value="r73">— Cirrus</option>
        <option value="r55-west-1">— Cloud region WEST-1</option>
        <option value="r55-north-1">— Cloud region NORTH-1</option>
        <option value="r55-east-1">— Cloud region EAST-1</option>
        <option value="r74">— Dis</option>
        <option value="c9">Swestore</option>
        <option value="r31">— dCache</option>
        <option value="r32">— iRODS</option>
        <option value="c4">UPPMAX</option>
        <option value="r48">— Bianca</option>
        <option value="r46">— Irma</option>
        <option value="r83">— Miarka</option>
        <option value="r51">— Rackham</option>
        <option value="r60">— Snowy</option>
        <option value="r84">— Vulpes</option>
        <option value="r40">— Fysast1</option>
        <option value="r28">— Milou</option>
        <option value="r39">— Smog</option>
        <option value="r20">— Tintin</option>
        <option value="r34">— topolino</option>
      </select>
